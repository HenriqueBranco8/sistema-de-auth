...
const registerUser = async (email, password) => {
    ...
    const rawData = fs_1.default.readFileSync(emails_1.pathData, "utf-8" /* Encoding.UTF8 */);
    ...
    const addUser = fs_1.default.writeFileSync(emails_1.pathData, dataString, "utf-8" /* Encoding.UTF8 */);
